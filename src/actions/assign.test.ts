...
import { AssignActionId, tryMakeAssignOptionsUserFriendly, tryUpgradeAssignMixOrLREncoding } from './assign.js'
...
describe('upgrading assign options to be more user-friendly', () => {
	...
	test.each([
		[AssignActionId.FXReturnToFXSend, 2, [0, 2], false, 3, [1, 3]],
		[AssignActionId.FXReturnToFXSend, 0, [], true, 1, []],
		[AssignActionId.FXReturnToGroup, 1, [0, 1, 2], true, 2, [1, 2, 3]],
		[AssignActionId.FXReturnToMix, 0, ['lr', 1, 2, 4], true, 1, ['LR', 2, 3, 5]],
		[AssignActionId.FXReturnToMix, 0, [3, 2, 'lr', 4], true, 1, [4, 3, 'LR', 5]],
		[AssignActionId.GroupToFXSend, 2, [0, 2], false, 3, [1, 3]],
		[AssignActionId.GroupToFXSend, 1, [1], false, 2, [2]],
		[AssignActionId.GroupToMatrix, 2, [2, 0], true, 3, [3, 1]],
		[AssignActionId.GroupToMix, 3, ['lr'], false, 4, ['LR']],
		[AssignActionId.InputChannelToFXSend, 16, [2, 0, 1], false, 17, [3, 1, 2]],
		[AssignActionId.InputChannelToGroup, 4, [0, 3], false, 5, [1, 4]],
		[AssignActionId.InputChannelToMix, 33, ['lr', 5, 18], true, 34, ['LR', 6, 19]],
		[AssignActionId.MixToMatrix, 'lr', [0], false, 'LR', [1]],
		[AssignActionId.MixToMatrix, 6, [0, 2], false, 7, [1, 3]],
	] satisfies [AssignActionId, number | 'lr', (number | 'lr')[], boolean, number | 'LR', (number | 'LR')[]][])(
		'$0 input=$1 assigns=$2 active=$3 => source=$4 sinks=$5',
		(actionId, input, assigns, active, expectedSource, expectedSinks) => {
			const {
